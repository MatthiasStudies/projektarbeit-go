...
- [Der Go Typechecker](#der-go-typechecker)
	...
	* [Typen](#typen)
		...
		+ [Komaptibilität von Typen](#komaptibilität-von-typen)
			...
			- [Implementierungsdetails des Go Typecheckers](#implementierungsdetails-des-go-typecheckers)
	* [Verbindung von AST und Typechecker](#verbindung-von-ast-und-typechecker)
	* [Verbesserung von Typeerrors](#verbesserung-von-typeerrors)
	* [Generics in Go's Typensystem](#generics-in-gos-typensystem)
		+ [Konsequenzen des Monomorphisierungsansatzes](#konsequenzen-des-monomorphisierungsansatzes)
		+ [Kontrast zu anderen Sprachen](#kontrast-zu-anderen-sprachen)
	* [Ablauf des Typecheckings](#ablauf-des-typecheckings)
	* [Ergebnis des Typechecker](#ergebnis-des-typechecker)
- [Mehrere Typefehler eines Programms finden](#mehrere-typefehler-eines-programms-finden)
	* [Die Idee](#die-idee)
	* [Implementierung](#implementierung)
			+ [Probleme und Einschränkungen](#probleme-und-einschränkungen)
- [Quellen und weiterführende Literatur](#quellen-und-weiterführende-literatur)
- [Angaben zur Nutzung von KI](#angaben-zur-nutzung-von-ki)
